                   ...
                   tabPanel(navtab4,
                            ...
                            sidebarLayout(
                              sidebarPanel(
                                ...
                                p("Note that 'ModelFreeShuffles' is considerably faster than 'NullModelFits'. For univariate applications, if using 'NullModelFits', consider lowering number of permutations for faster results in the web browser."),
                                br(),
